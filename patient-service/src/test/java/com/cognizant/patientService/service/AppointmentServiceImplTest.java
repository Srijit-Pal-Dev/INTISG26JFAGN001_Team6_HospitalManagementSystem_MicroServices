...
class AppointmentServiceImplTest {
    ...
    @Test
    void getAppointmentByPatientId_Success() {
        when(appointmentRepository.findByPatientId(1L)).thenReturn(Optional.of(appointment));

        AppointmentDTO result = appointmentService.getAppointmentByPatientId(1L);
    ...
    void getAppointmentByPatientId_NotFound() {
        when(appointmentRepository.findByPatientId(99L)).thenReturn(Optional.empty());
